...
10. 삭제된 사용자의 닉네임으로 다시 가입할 수 있는지 확인합니다.
11. 같은 닉네임으로 중복 가입하면 "이미 사용 중인 닉네임입니다"가 떠야 합니다.
12. 잘못된 PIN으로 로그인하면 실패해야 합니다.
13. 다른 일반 계정으로 로그인하면 기존 프로필/일정의 수정/삭제 버튼이 보이지 않아야 합니다.
